...
if (($K > 0) AND ($K <= 15)) { echo "Today the weather very much affects you.. Take care of yourself!";} 
elseif (($K > 15) AND ($K <= 23)) { echo "Today the weather is significantly affecting you. Be careful!'/>";}
elseif (($K > 23 ) AND ($K <= 30)) { echo "Medium effect of weather on you. Be careful.";}
elseif (($K > 30) AND ($K <= 35)) { echo "The effects of weather slightly today.";}
elseif ($K > 35) { echo "Today the weather will not affect your health and mood. Wonderful day!";}
